...
class Contact_Form {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('wp_ajax_store_contact_form_info', $plugin_public, 'store_contact_form_info');
		$this->loader->add_action('wp_ajax_nopriv_store_contact_form_info', $plugin_public, 'store_contact_form_info');
